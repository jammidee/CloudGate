...
svarGetTotalMemory: ["wm.ServiceVariable", {"inFlightBehavior":"executeLast","operation":"getSystemTotalMemory","service":"svcUtility"}, {"onResult":"svarGetTotalMemoryResult"}, {
input: ["wm.ServiceInput", {"type":"getSystemTotalMemoryInputs"}, {}]
}],
svarGetFreeMemory: ["wm.ServiceVariable", {"inFlightBehavior":"executeLast","operation":"getSystemFreeMemory","service":"svcUtility"}, {"onResult":"svarGetFreeMemoryResult"}, {
input: ["wm.ServiceInput", {"type":"getSystemFreeMemoryInputs"}, {}]
}],
svarGetOSName: ["wm.ServiceVariable", {"inFlightBehavior":"executeLast","operation":"getSystemOSName","service":"svcUtility"}, {"onResult":"svarGetOSNameResult"}, {
input: ["wm.ServiceInput", {"type":"getSystemOSNameInputs"}, {}]
}],
svarGetSystemInfoHTML: ["wm.ServiceVariable", {"inFlightBehavior":"executeLast","operation":"systemInfoToHtml","service":"svcUtility"}, {"onResult":"svarGetSystemInfoHTMLResult"}, {
input: ["wm.ServiceInput", {"type":"systemInfoToHtmlInputs"}, {}]
}],
pdLoading: ["wm.PageDialog", {"desktopHeight":"100px","height":"100px","hideControls":true,"pageName":"Main","width":"280px"}, {}],
ddPgMainConfigHelp: ["wm.DesignableDialog", {"buttonBarId":"buttonBar","containerWidgetId":"containerWidget","modal":false,"title":"Time Help"}, {}, {
containerWidget: ["wm.Container", {"_classes":{"domNode":["wmdialogcontainer","MainContent"]},"autoScroll":true,"height":"100%","horizontalAlign":"left","padding":"5","verticalAlign":"top","width":"100%"}, {}, {
contHelp: ["wm.Content", {"height":"100%","resource":"resources/htmlcontent/PgMainToolsTime.html"}, {}]
}],
buttonBar: ["wm.Panel", {"_classes":{"domNode":["dialogfooter"]},"border":"1,0,0,0","fitToContentHeight":true,"height":"33px","horizontalAlign":"right","layoutKind":"left-to-right","verticalAlign":"top","width":"100%"}, {}, {
...
pnlBody: ["wm.Panel", {"_classes":{"domNode":["wm_BackgroundColor_White"]},"height":"100%","horizontalAlign":"center","verticalAlign":"top","width":"100%"}, {}, {
lblTime: ["wm.Label", {"_classes":{"domNode":["wm_FontColor_LightBlue","wm_FontSizePx_36px","wm_TextAlign_Center","wm_FontFamily_Verdana","wm_TextDecoration_Bold"]},"caption":"00:00:00","height":"86px","padding":"4","width":"800px"}, {}, {
format: ["wm.DataFormatter", {}, {}]
}],
pnlOS: ["wm.Panel", {"fitToContentHeight":true,"height":"26px","horizontalAlign":"left","layoutKind":"left-to-right","verticalAlign":"top","width":"800px"}, {}, {
lblOSDesc: ["wm.Label", {"caption":"Operating System:","padding":"4","styles":{"fontWeight":"bolder"},"width":"140px"}, {}],
lblOS: ["wm.Label", {"caption":"---","padding":"4","width":"100%"}, {}]
}],
pnlMem: ["wm.Panel", {"fitToContentHeight":true,"height":"26px","horizontalAlign":"left","layoutKind":"left-to-right","verticalAlign":"top","width":"800px"}, {}, {
lblMemDesc: ["wm.Label", {"caption":"Total Memory:","padding":"4","styles":{"fontWeight":"bolder"},"width":"140px"}, {}],
lblMem: ["wm.Label", {"caption":"---","padding":"4","width":"100%"}, {}],
lblMemDesc1: ["wm.Label", {"caption":"Free Memory:","padding":"4","styles":{"fontWeight":"bolder"},"width":"140px"}, {}],
lblMemFree: ["wm.Label", {"caption":"---","padding":"4","width":"100%"}, {}]
}],
html_info: ["wm.Html", {"height":"100%","minDesktopHeight":15,"width":"800px"}, {}]
}],
...
PgMainToolsTime.prototype._cssText = 'body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-pnlHeader {\
background-image:url(resources/images/logos/waveerpbar.jpg) !important;\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-pnlTitle {\
background-image:url(resources/images/logos/waveerpbar.jpg) !important;\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-lblTitle {\
color:#666666;\
...
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-pnlMenuBar {\
background-color:#00008B;\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-pnlFooter {\
background-color:#00008B;\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-txtUserId {\
color:#666666;\
border: solid #CCCCCC 0;\
padding:5px;\
border-bottom-width: 0px;\
...
body.tundra .PgMainToolsTime .PgMainToolsTime-pnlLayoutMain.wmlayout {\
color:#666666;\
border: solid #CCCCCC 0;\
padding:5px;\
border-bottom-width: 0px;\
...
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-txtPassword {\
color:#666666;\
border: solid #CCCCCC 0;\
padding:5px;\
border-bottom-width: 0px;\
...
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-lblManageTicket {\
font-family: Tahoma;\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-lblUserInfo {\
font-family:Tahoma;\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-lblBorder {\
font-family:Tahoma;\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-lblLogout {\
font-family:Tahoma;\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-lblSep {\
font-family:Tahoma;\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-lblManageUser {\
font-family:Tahoma;\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-pnlBody {\
}\
body.tundra .PgMainToolsTime .wmlayout .PgMainToolsTime-lblManageLookUp {\
font-family:Tahoma;\
}\
';
PgMainToolsTime.prototype._htmlText = '';