 ...
 * Date: 11/16/2012
 * Modified by: Jammi Dee 11/16/2012
 * 
*/
...
dojo.declare("PgMainMaintenanceSession", wm.Page, {
    ...
    start: function() {
        try {
            ...
            this.pnlControl.setShowing(false);
            ...
            this.svarSessionView.setValue("input.pEntity", app.varEntity.getValue("dataValue"));
            this.svarSessionView.update();
            
            // Added by Jammi Dee 05/06/2012 
            app.svarLogging.setValue("input.pUserId",app.varUserId.getValue("dataValue"));
            app.svarLogging.setValue("input.pMsg","View Sessions.");
    ...
    */
    initApplication: function() {
        ...
        this.lblTitle.setCaption("Maintenance : Sessions" );
