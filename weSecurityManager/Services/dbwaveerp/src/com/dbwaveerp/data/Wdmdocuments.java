...
public class Wdmdocuments {
    ...
    private Date doclastchg;
    private Integer wflow;
    ...
    public Date getDoclastchg() {
        return doclastchg;
    }

    public void setDoclastchg(Date doclastchg) {
        this.doclastchg = doclastchg;
    }

    public Integer getWflow() {
        return wflow;
    }

    public void setWflow(Integer wflow) {
        this.wflow = wflow;
    }
